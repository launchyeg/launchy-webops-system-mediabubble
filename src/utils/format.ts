...
// Built manually (number formatting + a literal "EGP" suffix) rather than
...
// this guarantees the same "1,234 EGP" output everywhere.
...
export function formatEgp(value: number | null | undefined): string {
  ...
  return `${egpNumberFormatter.format(amount)} EGP`;
}
